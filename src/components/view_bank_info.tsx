...
import { loadLocalBanks, verifyBankDetails } from '../services/auth';
...
const BankInfoView = (props: any) => {
  ...
  const verifyDetails = useCallback(() => {
  ...
  }, [selectedBank, accountNumber, verifyDetails]);
  ...
  return (
    <View>
      ...
      {isLoadingDetails ? (
        <ActivityIndicator
          style={styles.accountNameProgress}
          size="small"
